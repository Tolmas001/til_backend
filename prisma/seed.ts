...
async function main() {
  ...
  // 1. Seed Story Locations
  const locationsData = [
    { name: 'Airport (Aeroport)', description: 'Rossiyaga kelish va pasport nazorati suhbati', order: 1, level: Level.A0, unlocked: true },
    { name: 'Taxi (Taksi)', description: 'Aeroportdan shahar markaziga borish va manzilni aytish', order: 2, level: Level.A0, unlocked: true },
    { name: 'Hotel (Mehmonxona)', description: 'Mehmonxonaga joylashish va xona bron qilish', order: 3, level: Level.A1, unlocked: false },
    { name: 'Restaurant (Restoran)', description: 'Oziq-ovqat buyurtma qilish va hisobni so\'rash', order: 4, level: Level.A1, unlocked: false },
    { name: 'University (Universitet)', description: 'O\'qishga topshirish va talabalik hayoti', order: 5, level: Level.A2, unlocked: false },
    { name: 'Work (Ish)', description: 'Ish suhbati va kasbiy muloqot', order: 6, level: Level.B1, unlocked: false },
    { name: 'Travel (Sayohat)', description: 'Rossiya bo\'ylab sarguzashtlar va madaniy sayohat', order: 7, level: Level.B2, unlocked: false },
  ];
