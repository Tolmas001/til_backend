...
export declare class TeacherCmsController {
    private teacherCmsService;
    constructor(teacherCmsService: TeacherCmsService);
    ...
    addOrganizationMember(organizationId: string, body: {
        userId: string;
        role: string;
        permissions?: any;
    }): Promise<{
